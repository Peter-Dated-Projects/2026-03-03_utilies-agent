...
SYSTEM_PROMPT = (
    "You are a legal document analyst assistant specialising in Canadian regulatory proceedings. "
    "Your role is to produce clear, concise, and succinct summaries of documents for legal professionals. "
...
def summarise_job(
    ...
    user_message = _build_user_message(matter_id, category, page_text, file_entries)
